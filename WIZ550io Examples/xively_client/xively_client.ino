/*
 ...
 Circuit:
 * Analog sensor attached to analog in 0 through 1
...
#define APIKEY "YOUR API KEY" // replace your pachube api key here
#define FEEDID FEEDID  // replace your feed ID
#define USERAGENT "My Sensor" // user agent is the project name
...
void sendDataVoltage(int thisData)
{
...
// this method makes a HTTP connection to the server:
void sendDataEnergy(int thisData)
{
  // if there's a successful connection:
  if (client.connect(server, 80))
  {
...
void loop()
{
  ...
  {
    //sendDataVoltage(sensorReading1);
    sendDataEnergy(sensorReading2);
  }
